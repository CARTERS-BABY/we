...
poseNet.on('pose' , gotpose )
 ...
 function gotpose(resultado){
  if(resultado.length > 0 ){
pulsoX = resultado[0].pose.rightWrist.x
pulsoY = resultado[0].pose.rightWrist.y
score = resultado[0].pose.keypoints[10].score
...
if(pcscore ==4){
    ...
    text('clike no botao reiniciar para jogar novamente' ,width/2,height/2)
